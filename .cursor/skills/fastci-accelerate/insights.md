...
**How to apply:**
- SEE "### Workflow YAML: GitHub Actions caching" section
...
**MUST**: change the image to debian based
**MUST**: remove all apk related code
```dockerfile
FROM docker pull lukemathwalker/cargo-chef:latest-rust-slim-trixie AS chef
